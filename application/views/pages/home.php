...
body {
    ...
    <body style="background-color:white;">
        ...
        <div class="text-center">
            <div><br>&nbsp</div>
            <h2><b><u>Vítej v našem autoservisu FaS</u></b></h2>
        </div>
    ...
    <div class="row">
        <div class="col-6">
                ...
                <ul>
                    ...
                    <li>Výměna olejů</li>
                    <li>Kontrola a seřízení brzd na brzdové stolici</li>
                    <li>Zajištění odtahu nepojízdného vozidla</li>
                </ul>
        </div>
        <div class="col-6">
                ...
                <ul>
                    ...
                    <li>Běžné opravy nástaveb</li>
                    <li>Seřízení geometrie přední nápravy</li>
                </ul>
        </div>
        </div>
    <div><br>&nbsp</div>
    ...
    <div class="row">
        <div class="col-6">
            <img src="<?php echo base_url ('images/os_auto.jpg'); ?>" class="rounded" width="400" height="250" alt="Oprava osobního automobilu">     
        </div>
        
        <div class="col-6">
            <img src="<?php echo base_url ('images/nak_auto.jpg'); ?>" class="rounded" width="400" height="250" alt="Oprava nákladního automobilu">   
        </div>
    </div>
    </div>
    <div><br>&nbsp</div>
